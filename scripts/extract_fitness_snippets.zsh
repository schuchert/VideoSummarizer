...
extracted=$(echo "$transcript" | grep -iE \
  "(shak|flex|stretch|HRV|heart|qigong|tai.*chi|bagua|liuhebafa|paradox|singularity|neural|flare|somatic|emptiness|collapse|energy|stability|practice|movement|awareness|observe|gyro|mandelbrot|hrv)" \
